...
typedef struct
{
    ...
    lv_obj_t *working_label_massage_title;
    lv_obj_t *working_label_time_title;
    lv_obj_t *working_cont_controls;
    lv_obj_t *working_cont_function_buttons;
    lv_obj_t *working_dialog;
    lv_obj_t *working_img_dialog_background;
    lv_obj_t *working_cont_return_dialog;
    lv_obj_t *working_label_return_warning;
    lv_obj_t *working_btn_no;
    lv_obj_t *working_btn_no_label;
    lv_obj_t *working_btn_yes;
    lv_obj_t *working_btn_yes_label;
    lv_obj_t *working_label_return_title;
