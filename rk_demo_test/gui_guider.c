...
// true表示这些页面不存在，还需要被创建
void init_scr_del_flag(lv_ui *ui)
{

    ui->index_del = true;
    ui->setting_del = true;
    ui->preparing_del = true;
    ui->location_del = true;
    ui->working_del = true;
    ui->conf_advance_del = true;
    ui->conf_mode_del = true;
    ui->conf_mode_detail_del = true;
    ui->conf_wifi_del = true;
    ui->conf_other_del = true;
    ui->conf_location_del = true;
