                          ...
                          robot_chassis_command_t *command)
{
    ...
    return finalize_command(create_t_root(t), t, dangerous,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
...
int robot_chassis_build_heartbeat(robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, 0, false,
...
int robot_chassis_build_reboot(robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, 0, true,
...
int robot_chassis_build_status_query(robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, ROBOT_CHASSIS_T_STATUS, false,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
                                    ...
                                    robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, ROBOT_CHASSIS_T_MANUAL_MOVE, false,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
                             ...
                             robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, ROBOT_CHASSIS_T_GOTO_POINT, false,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
                                     ...
                                     robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, ROBOT_CHASSIS_T_START_CHARGE, false,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
...
int robot_chassis_build_cancel_charge(robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, ROBOT_CHASSIS_T_CANCEL_CHARGE, false,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
                                     ...
                                     robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, ROBOT_CHASSIS_T_AUTO_EXPLORE, true,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
                                 ...
                                 robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, ROBOT_CHASSIS_T_LOCK_MAP, false,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
                                  ...
                                  robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, ROBOT_CHASSIS_T_INIT_POSE, false,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
                                  ...
                                  robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, ROBOT_CHASSIS_T_SOFT_STOP, false,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
                                 ...
                                 robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, ROBOT_CHASSIS_T_SAVE_MAP, true,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
...
int robot_chassis_build_factory_reset(robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, ROBOT_CHASSIS_T_FACTORY_RESET, true,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
                                 ...
                                 robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, ROBOT_CHASSIS_T_SET_TIME, false,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
                                      ...
                                      robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, ROBOT_CHASSIS_T_UPGRADE_BEGIN, true,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
                                      ...
                                      robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, ROBOT_CHASSIS_T_UPGRADE_CHUNK, false,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
                                       ...
                                       robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, ROBOT_CHASSIS_T_UPGRADE_FINISH, false,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
                                        ...
                                        robot_chassis_command_t *command)
{
    ...
    return finalize_command(root, ROBOT_CHASSIS_T_UPGRADE_EXTRACT, false,
                            ROBOT_CHASSIS_CMD_NONE, command);
}
