...
void setup_scr_index(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->index_panel_status, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->index_panel_status, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_shadow_color(ui->index_panel_status, lv_color_hex(0x2a3a47), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->index_panel_status, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->index_panel_status, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->index_panel_status, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->index_panel_status, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_color(ui->index_cont_1, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->index_cont_1, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->index_cont_2, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->index_water_info, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->index_water_info, &lv_font_SourceHanSansSC_Regular_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(ui->index_water_info, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->index_time_info, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->index_time_info, &lv_font_SourceHanSansSC_Regular_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(ui->index_time_info, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->index_temp_value, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->index_temp_value, &lv_font_SourceHanSansSC_Regular_70, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(ui->index_temp_value, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->index_img_medicine1, 179, 93);
    ...
    lv_obj_set_pos(ui->index_img_medicine2, 215, 93);
    ...
    lv_obj_set_pos(ui->index_label_need_liquid, 69, 94);
    lv_obj_set_size(ui->index_label_need_liquid, 68, 32);
    lv_label_set_text(ui->index_label_need_liquid, "缺液");
    lv_label_set_long_mode(ui->index_label_need_liquid, LV_LABEL_LONG_WRAP);
    ...
    lv_obj_set_style_text_color(ui->index_label_need_liquid, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->index_label_need_liquid, &lv_font_SourceHanSansSC_Regular_25, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(ui->index_label_need_liquid, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->index_cont_clean, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->index_cont_clean, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->index_label_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->index_label_1, &lv_font_SourceHanSansSC_Regular_40, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(ui->index_label_1, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
