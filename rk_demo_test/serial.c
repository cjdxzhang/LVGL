...
static uint8_t timer_seconds_to_protocol(uint32_t seconds)
{
    switch (seconds) {
        case 0:     return 0x00u;
        case 600:   return 0x01u;
        case 900:   return 0x02u;
        case 1200:  return 0x03u;
        case 1500:  return 0x04u;
        case 1800:  return 0x05u;
...
static void build_tx_frame(uint8_t frame[SERIAL_FRAME_LEN])
{
    ...
    frame[2] = link_mode;
    frame[3] = cmd_type;
    frame[4] = 0x00;//g_serial.last_link_status;
    frame[5] = 0x00;
...
void serial_base_force_drain(void)
{
    ...
    g_is_draining = true;  // 设置全局变量，表示正在排水
}
