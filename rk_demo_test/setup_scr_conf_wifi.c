...
void setup_scr_conf_wifi(lv_ui *ui)
{
    ...
    lv_obj_set_style_border_color(ui->conf_wifi_cont_1, lv_color_hex(0x2195f6),
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->conf_wifi_cont_1, LV_BORDER_SIDE_FULL,
                                 LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->conf_wifi_cont_1, lv_color_hex(0xffffff),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->conf_wifi_cont_1, LV_GRAD_DIR_NONE,
                                 LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_line_color(ui->conf_wifi_line_1, lv_color_hex(0xffffff),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->conf_wifi_btn_2, lv_color_hex(0x2195f6),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->conf_wifi_btn_2, LV_GRAD_DIR_NONE,
                                 LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->conf_wifi_btn_2, lv_color_hex(0xffffff),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->conf_wifi_btn_2, &lv_font_SourceHanSansSC_Regular_18,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->conf_wifi_btn_2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->conf_wifi_btn_2, LV_TEXT_ALIGN_CENTER,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->conf_wifi_btn_2_label, &lv_font_SourceHanSansSC_Regular_18,
                               LV_PART_MAIN | LV_STATE_DEFAULT);

    // Keep the button visible while a background connection is in progress.
    lv_obj_set_style_bg_color(ui->conf_wifi_btn_2, lv_color_hex(0x9b91a6),
    ...
    // wlan0 当前 IPv4，地址由后台状态监控更新，无有效地址时保持隐藏。
    ui->conf_wifi_ip_label = lv_label_create(ui->conf_wifi_cont_1);
    lv_obj_set_pos(ui->conf_wifi_ip_label, 380, 334);
    lv_obj_set_size(ui->conf_wifi_ip_label, 165, 26);
    lv_label_set_text(ui->conf_wifi_ip_label, "");
    lv_label_set_long_mode(ui->conf_wifi_ip_label, LV_LABEL_LONG_CLIP);
    lv_obj_set_style_text_font(ui->conf_wifi_ip_label, &lv_font_SourceHanSansSC_Regular_18,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->conf_wifi_ip_label, lv_color_hex(0xffffff),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->conf_wifi_ip_label, LV_TEXT_ALIGN_LEFT,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->conf_wifi_label_3, lv_color_hex(0xffffff),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->conf_wifi_label_3, &lv_font_SourceHanSansSC_Regular_30,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(ui->conf_wifi_label_3, LV_TEXT_ALIGN_CENTER,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->conf_wifi_wifi_ssid, lv_color_hex(0x937dad),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->conf_wifi_wifi_ssid, &lv_font_SourceHanSansSC_Regular_25,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->conf_wifi_wifi_ssid, lv_color_hex(0xffffff),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->conf_wifi_wifi_ssid, LV_GRAD_DIR_NONE,
                                 LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_style_set_border_color(&style_conf_wifi_wifi_ssid_extra_list_selected_checked,
                              lv_color_hex(0xe1e6ee));
    lv_style_set_border_side(&style_conf_wifi_wifi_ssid_extra_list_selected_checked,
                             LV_BORDER_SIDE_FULL);
    ...
    lv_style_set_bg_color(&style_conf_wifi_wifi_ssid_extra_list_selected_checked,
                          lv_color_hex(0x00a1b5));
    lv_style_set_bg_grad_dir(&style_conf_wifi_wifi_ssid_extra_list_selected_checked, LV_GRAD_DIR_NONE);
    lv_obj_add_style(lv_dropdown_get_list(ui->conf_wifi_wifi_ssid),
                     &style_conf_wifi_wifi_ssid_extra_list_selected_checked, LV_PART_SELECTED | LV_STATE_CHECKED);
    ...
    lv_style_set_text_font(&style_conf_wifi_wifi_ssid_extra_list_main_default,
    ...
    lv_obj_add_style(lv_dropdown_get_list(ui->conf_wifi_wifi_ssid),
                     &style_conf_wifi_wifi_ssid_extra_list_main_default, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_style_set_bg_color(&style_conf_wifi_wifi_ssid_extra_list_scrollbar_default,
                          lv_color_hex(0x00ff00));
    lv_style_set_bg_grad_dir(&style_conf_wifi_wifi_ssid_extra_list_scrollbar_default, LV_GRAD_DIR_NONE);
    lv_obj_add_style(lv_dropdown_get_list(ui->conf_wifi_wifi_ssid),
                     &style_conf_wifi_wifi_ssid_extra_list_scrollbar_default, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->conf_wifi_wifi_pwd, lv_color_hex(0x937dad),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->conf_wifi_wifi_pwd, &lv_font_SourceHanSansSC_Regular_25,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(ui->conf_wifi_wifi_pwd, LV_TEXT_ALIGN_CENTER,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->conf_wifi_wifi_pwd, 144, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->conf_wifi_wifi_pwd, lv_color_hex(0xffffff),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->conf_wifi_wifi_pwd, LV_GRAD_DIR_NONE,
                                 LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->conf_wifi_wifi_pwd, lv_color_hex(0x2195f6),
    ...
    lv_label_set_text(ui->conf_wifi_label_4,
                      "请确保链接的家庭wi-fi网络为2.4G或2.4/5G混合网络");
    ...
    lv_obj_set_style_text_color(ui->conf_wifi_label_4, lv_color_hex(0xffffff),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->conf_wifi_label_4, &lv_font_SourceHanSansSC_Regular_30,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(ui->conf_wifi_label_4, LV_TEXT_ALIGN_LEFT,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
