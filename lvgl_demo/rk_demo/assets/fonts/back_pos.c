 ...
 * Size: 63 px
 * Bpp: 4
 * Opts: --bpp 4 --size 63 --no-compress --stride 1 --align 1 --font iconfont.ttf --range 58881 --format lvgl -o back_pos.c
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x87, 0x65,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 1175, .box_w = 74, .box_h = 64, .ofs_x = 0, .ofs_y = -8}
};
